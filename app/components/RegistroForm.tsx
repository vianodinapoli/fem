...
type Props = {
  ...
  setUltimaAtualizacao?: (data: Date) => void // Prop opcional para atualizar a data/hora
}
...
export default function RegistroForm({
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // Atualiza data/hora de última modificação
      ...
      <div className="w-full flex flex-wrap justify-center items-end gap-4">
        <div className="flex flex-col w-[150px]">
          ...
          <input
            ...
            name="data"
            defaultValue={
              registro?.data?.split('T')[0] || new Date().toISOString().split('T')[0]
            }
            required
